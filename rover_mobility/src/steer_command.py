...
class SteerClaw:
	...
	def __init__(self, address, dev_name, baud_rate, kp1 = 0.35, kp2 = 0.35, qpps1 = 5.34, qpps2 = 5.34, deadzone1 = 50, deadzone2 = 50, kon1 = 10, kon2 = 10, ovf = 1922):
	...
	def update(self):
		...
		enc2Pos = self.claw.ReadEncM2()[1] % self.ovf
...
if __name__ == "__main__":
	...
	for i in range(20):
		try:
			roboclaw1 = SteerClaw(0x80, "/dev/ttyACM2", 9600)
